...
function App() {
  ...
  const [bottomPanelHeight, setBottomPanelHeight] = useState(() => {
    const saved = localStorage.getItem('viraloop_bottomPanelHeight')
  ...
  useEffect(() => {
    localStorage.setItem('viraloop_bottomPanelHeight', String(bottomPanelHeight))
  }, [bottomPanelHeight])
  ...
  useEffect(() => {
    ...
    const settingsSaved = localStorage.getItem('viraloop_settings')
    ...
    const saved = localStorage.getItem('viraloop_savedPrompts')
    if (saved) {
    ...
    const savedVideo = localStorage.getItem('viraloop_savedVideoPrompts')
    if (savedVideo) {
  ...
  const handleTextChange = (text) => {
    ...
    localStorage.setItem('viraloop_savedPrompts', text)
  }
  ...
  const handleVideoTextChange = (text) => {
    ...
    localStorage.setItem('viraloop_savedVideoPrompts', text)
  }
  ...
  const handleHardReset = useCallback(async () => {
    ...
    localStorage.removeItem('viraloop_savedPrompts')
    localStorage.removeItem('viraloop_savedVideoPrompts')
    localStorage.removeItem('audioFolderPath')
